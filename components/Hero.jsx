...
const Hero = () => {
    ...
    return <section className='min-h-screen flex items-center justify-center relative overflow-hidden'>
        <div className='text-center z-10 px-6'>
            <div className={`tarnsition-all duration-1000 ${textVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
                ...
                <p className='text-xl text-gray-400 mb-8 max-w-3xl mx-auto leading-relaxed'>
                    Professional image editing powered by AI. Crop, resize, adjust colors, remove background, and enhance your images with cutting-edge technology.
                </p>
            ...
            <div
                className={`relative max-w-4xl mx-auto transition-all duration-1000 ${textVisible
                    ...
                    } ${demoHover ? "transform scale-105 rotate-y-6" : ""}`}
                    ...
                    <div className="bg-gradient-to-r from-slate-900 to-slate-800 rounded-2xl p-8 min-h-96">
                        ...
                        <div className="grid grid-cols-3 gap-4 mb-6">
                            {[
                                ...
                                { icon: "🎨", label: "Adjust" },
                                { icon: "🤖", label: "AI Tools" },
                                { icon: "Th", label: "Thumbnail Generator" }
                            ].map((tool, index) => (
                                <div
                                    key={index}
                        ...
                        <div className="flex items-center justify-center">
                            <div className="w-full h-42 bg-gradient-to-r from-blue-500 via-purple-500 to-cyan-600 rounded-2xl shadow-2xl shadow-blue-500/50 flex items-center justify-center">
                                <div className="text-white font-bold text-xl">Your Canvas</div>
                            </div>
                        </div>
                    </div>
                </div>
